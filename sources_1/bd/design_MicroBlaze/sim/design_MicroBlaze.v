...
(* CORE_GENERATION_INFO = "design_MicroBlaze,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_MicroBlaze,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=6,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_board_cnt=12,da_mb_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_MicroBlaze.hwdef" *) 
module design_MicroBlaze
   (button_tri_i,
    ...
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 button " *) input [4:0]button_tri_i;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN design_MicroBlaze_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input sys_clock;
  ...
  assign axi_gpio_1_GPIO_TRI_I = button_tri_i[4:0];
  assign axi_uartlite_0_UART_RxD = usb_uart_rxd;
  assign button_tri_o[4:0] = axi_gpio_1_GPIO_TRI_O;
  assign button_tri_t[4:0] = axi_gpio_1_GPIO_TRI_T;
  ...
  design_MicroBlaze_axi_gpio_0_0 axi_gpio_0
  ...
  design_MicroBlaze_axi_gpio_1_0 axi_gpio_1
  ...
  microblaze_0_local_memory_imp_V1ZB8O microblaze_0_local_memory
...
module design_MicroBlaze_microblaze_0_axi_periph_0
  ...
  m00_couplers_imp_1UNVDHR m00_couplers
  ...
  m01_couplers_imp_1829AA6 m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m02_couplers_imp_CL0CCT m02_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_KBCE29 s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m00_couplers_imp_1UNVDHR
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_1829AA6
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m02_couplers_imp_CL0CCT
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_V1ZB8O
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
...
module s00_couplers_imp_KBCE29
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
