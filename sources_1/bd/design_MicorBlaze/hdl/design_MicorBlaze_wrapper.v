...
//Command     : generate_target design_MicorBlaze_wrapper.bd
//Design      : design_MicorBlaze_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_MicorBlaze_wrapper
   (button_tri_io,
    led_tri_io,
    reset,
    sys_clock,
  ...
  IOBUF button_tri_iobuf_4
       (.I(button_tri_o_4),
        ...
        .O(button_tri_i_4),
        .T(button_tri_t_4));
  IOBUF button_tri_iobuf_5
       (.I(button_tri_o_5),
        .IO(button_tri_io[5]),
        .O(button_tri_i_5),
        .T(button_tri_t_5));
  IOBUF button_tri_iobuf_6
       (.I(button_tri_o_6),
        .IO(button_tri_io[6]),
        .O(button_tri_i_6),
        .T(button_tri_t_6));
  IOBUF button_tri_iobuf_7
       (.I(button_tri_o_7),
        .IO(button_tri_io[7]),
        .O(button_tri_i_7),
        .T(button_tri_t_7));
  design_MicorBlaze design_MicorBlaze_i
       (.button_tri_i({button_tri_i_7,button_tri_i_6,button_tri_i_5,button_tri_i_4,button_tri_i_3,button_tri_i_2,button_tri_i_1,button_tri_i_0}),
        .button_tri_o({button_tri_o_7,button_tri_o_6,button_tri_o_5,button_tri_o_4,button_tri_o_3,button_tri_o_2,button_tri_o_1,button_tri_o_0}),
        .button_tri_t({button_tri_t_7,button_tri_t_6,button_tri_t_5,button_tri_t_4,button_tri_t_3,button_tri_t_2,button_tri_t_1,button_tri_t_0}),
