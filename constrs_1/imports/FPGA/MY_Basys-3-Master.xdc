...
set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { button_tri_io[4]  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
set_property -dict { PACKAGE_PIN V3   IOSTANDARD LVCMOS33 } [get_ports { button_tri_io[5]  }]; #IO_L6P_T0_34                 ,Sch=LED9
set_property -dict { PACKAGE_PIN W3   IOSTANDARD LVCMOS33 } [get_ports { button_tri_io[6] }]; #IO_L6N_T0_VREF_34            ,Sch=LED10
set_property -dict { PACKAGE_PIN U3   IOSTANDARD LVCMOS33 } [get_ports { button_tri_io[7] }]; #IO_L9P_T1_DQS_34             ,Sch=LED11
